...
from gui_components import StatusBar, ModelSelectionFrame, DatasetSelectionFrame, ImageCanvas, ProgressDialog
...
class YOLOLabelerApp(tk.Tk):
    ...
    def __init__(self):
        ...
        # Create main frame (no scrolling)
        self.scrollable_frame = tk.Frame(self, bg=APP_BG_COLOR)
    ...
    def create_scrollable_interface(self):
        """Create scrollable main interface - DISABLED FOR NO SCROLLING"""
        # Scrolling disabled - using simple frame instead
        pass
    
    def bind_mousewheel(self):
        """Bind mouse wheel events for scrolling - DISABLED FOR NO SCROLLING"""
        # Scrolling disabled
        pass
    ...
    def create_widgets(self):
        ...
        # Tab 3: Roboflow Management (HIDDEN)
        self.roboflow_frame = tk.Frame(self.notebook, bg=APP_BG_COLOR)
        # self.notebook.add(self.roboflow_frame, text="Roboflow Projects")  # Hidden - uncomment to show
    ...
    def setup_labeling_tab(self):
        ...
        self.create_status_panel(self.middle_panel)  # Status Panel removed
